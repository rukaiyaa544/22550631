...
public class TC014 extends BaseTest {
    ...
    @Test (groups = {"TS004"})
    public void TC014_SelectArtist5() {
        ...
        try {
            ...
            product.setDeletCart();


            WebElement myAccount = driver.findElement(By.xpath("//h1[text()='Basket']"));
            Assert.assertTrue(myAccount.isDisplayed(), "Error in deleting the item to the Basket ");
        ...
        logger.info("***  Finish TC014 Test Case  ***");
